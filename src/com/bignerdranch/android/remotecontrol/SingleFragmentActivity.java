...
public abstract class SingleFragmentActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Fragment fragment = fm.findFragmentById(R.id.fragment_remote_control_tableLayout);
		...
		if(fragment == null) {
			...
			fm.beginTransaction().add(R.id.fragment_remote_control_tableLayout, fragment).commit();
		}
